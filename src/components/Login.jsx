        ...
        <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/10 via-secondary/5 to-accent/10 p-4 pb-48'>
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-base-content/60">Sign in to your DevTinder account</p>
                </div>
                ...
                <div className="card bg-base-100/80 backdrop-blur-xl shadow-2xl border border-base-300/50 hover:shadow-3xl transition-all duration-300">
                    <div className="card-body p-8">
                        ...
                        <button onClick={handleLogin} className="btn btn-primary w-full mb-4 bg-gradient-to-r from-primary to-secondary hover:from-primary-focus hover:to-secondary-focus border-none shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300">
                        ...
                        <div className="text-center">
                            <span className="text-base-content/60 text-sm">Don't have an account? </span>
                            <a href="#" className="text-primary hover:text-primary-focus font-medium transition-colors duration-200">
                                Sign up here
                            </a>
                        </div>
                    </div>
